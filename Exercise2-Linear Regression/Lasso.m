function [w] = Lasso(X, y, X_test, y_test)

%This script is designed for Exercise 2 Question 1
[sz1,~] = size(X);
...
res = table(all_lambda,mean_square_error_train.',non_zero_precent_train.',mean_square_error_valid.',non_zero_precent_valid.',mean_square_error_test.');
res.Properties.VariableNames = {'Lambda' 'Training_MSE' 'Training_nonZero' 'Valid_MSE' 'Valid_nonZero' 'Test_MSE'};
res
